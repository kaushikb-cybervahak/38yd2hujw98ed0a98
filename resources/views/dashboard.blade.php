...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h2 class="box-title">License Utilisation Rate</h2>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse">
                        <x-icon type="minus" />
                        <span class="sr-only">{{ trans('general.collapse') }}</span>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                        <table
                            data-cookie-id-table="dashLicenseUtilisationRate"
                            data-height="400"
                            data-pagination="true"
                            data-side-pagination="server"
                            data-sort-order="desc"
                            data-sort-field="id"
                            id="dashLicenseUtilisationRate"
                            class="table table-striped snipe-table"
                            data-url="{{ route('api.license.utilisation.rate', ['sort' => 'id', 'order' => 'desc']) }}">
    ...
    <div class="col-md-6">
        <div class="box box-default">
            <div class="box-header with-border">
                <h2 class="box-title">
                    Hardware Asset Warranty Remaining Years
                </h2>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse" aria-hidden="true">
                        <x-icon type="minus" />
...
<script>
    $(document).ready(function(){
        var barChartCanvas = $("#barChartView").get(0).getContext("2d");
        var barChart = new Chart(barChartCanvas);
        var barChartCtx = document.getElementById("barChartView");
        var barChartOptions = {
            responsive: true,
            maintainAspectRatio: true,
            scales: {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('get.hardware.asset.warranty')}}",
            headers: {
                "X-Requested-With": 'XMLHttpRequest',
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr('content')
            },
        ...
        //Asset Age Doughtnut chart
        var doughnutChartCanvas = $("#hardwareAssetAgeChart").get(0).getContext("2d");
        var doughnutChartCtx = document.getElementById("hardwareAssetAgeChart");
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('get.hardware.asset.age') }}",
            headers: {
                "X-Requested-With": 'XMLHttpRequest',
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr('content')
            },
            dataType: "json",
            success: function (doughnutChartData) {
                console.log(doughnutChartData);
                var myDoughnutChart = new Chart(doughnutChartCtx, {
                    type: 'doughnut', // Change from 'bar' to 'doughnut'
                    data: doughnutChartData, // Ensure data format is suitable for doughnut chart
