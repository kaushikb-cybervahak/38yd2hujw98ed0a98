...
use App\Http\Controllers\LocationWiseChartController;
...
Route::get('get-hardware-asset-warranty', [DashboardController::class, 'getHardwareAssetWarranty'])->name('get.hardware.asset.warranty');
Route::get('get-hardware-asset-age', [DashboardController::class, 'getHardwareAssetAge'])->name('get.hardware.asset.age');

Route::get('location/chart', [LocationWiseChartController::class, 'index'])->name('location.chart.index');
Route::get('get-location-wise-graph', [LocationWiseChartController::class, 'getLocationWiseGraph'])->name('get.location.wise.graph');
